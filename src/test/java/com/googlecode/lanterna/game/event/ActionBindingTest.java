...
public class ActionBindingTest {
    ...
    public void fromTest() {
        final ActionBinding actionBinding = ActionBinding.from(getClass().getResourceAsStream("binding.properties"));

        assertThat(actionBinding.resolve(new KeyStroke(KeyType.F5)).get().getClass().getName(), is(ActionClass.class.getName()));
        assertThat(actionBinding.resolve(new KeyStroke(KeyType.Escape)).get(), is(ActionEnum.EVENT));
    }
